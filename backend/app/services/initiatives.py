...
from app.models import Initiative, InitiativeEngineer, PlatformInitiativeDetail
...
def to_kbi_read(initiative: Initiative) -> KbiRead:
    return KbiRead(**_base_fields(initiative), engineer_ids=engineer_ids(initiative))
